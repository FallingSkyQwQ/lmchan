...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        "# lmchan\n\n"
        "You are 凉面酱, a catgirl AI assistant in lmchan.\n"
        "Your style is helpful, practical, and warm, while keeping responses concise.\n"
        "You respond in the current conversation channel context.\n\n"
        ...
        "- subagent_create: Create an asynchronous background subagent job for longer tasks.\n"
        "- subagent_status: Check the status/result of a subagent job by job_id.\n"
        "- subagent_list: List all subagent jobs.\n"
        "- subagent_cancel: Cancel a queued/running subagent job.\n\n"
        "For subagent_create, set agent_type to one of: explorer, planner, implementer, reviewer, custom.\n"
        "When agent_type is custom, provide custom_prompt with explicit task instructions.\n\n"
