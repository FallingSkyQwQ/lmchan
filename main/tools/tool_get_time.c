...
/* Fetch time via proxy: HEAD request to open.feishu.cn, parse Date header */
static esp_err_t fetch_time_via_proxy(char *out, size_t out_size)
{
    proxy_conn_t *conn = proxy_conn_open("open.feishu.cn", 443, 10000);
