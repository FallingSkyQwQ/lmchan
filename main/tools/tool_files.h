 ...
 * Input JSON: {"path": "<LMCHAN_SPIFFS_BASE>/...", "old_string": "...", "new_string": "..."}
 */
 ...
 * Input JSON: {"prefix": "<LMCHAN_SPIFFS_BASE>/..."} (prefix is optional)
 */
